  ...
  return (
    <Box p={5}>
      ...
      <Heading textAlign={'center'} fontSize={{
        base: '16px',
        lg: '26px',
      }} pb={2}>Which country's coat of arms?</Heading>
      <Box display={'flex'} alignItems={'center'} justifyContent={'center'} px={3} pt={1}>
        <Image w={300} h={200} src={countryItem[randomAnswerNumber]?.coatOfArms?.svg}/>
      </Box>
      <Divider my={3}/>
...
export default GamesPanelCoatOfArms